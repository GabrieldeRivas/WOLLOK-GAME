...
class MarcadorUnidad inherits Bloque {
	override method image() {
		...
		if (personajeSimple.energia()%10 == 8) {
			return "md8.png"
		}
		if (personajeSimple.energia()%10 == 7) {
			return "md7.png"
		}
		if (personajeSimple.energia()%10 == 6) {
			return "md6.png"
		}
		if (personajeSimple.energia()%10 == 5) {
			return "md5.png"
		}
		if (personajeSimple.energia()%10 == 4) {
			return "md4.png"
		}
		if (personajeSimple.energia()%10 == 3) {
			return "md3.png"
		}
		if (personajeSimple.energia()%10 == 2) {
			return "md2.png"
		}
		if (personajeSimple.energia()%10 == 1) {
			return "md1.png"
		}
		else {
			return "md0.png"
